...
testLinkNode = LeafNode(tag = "a", value = "Some Text here", props={"href":"https://google.com", "target": "_blank"})
testTextNode = LeafNode(tag = "p", value = "Some Text here")
testChildList = [LeafNode(tag = "b", value = "Some Text here"), LeafNode(tag = "i", value = "Some italics here"), LeafNode(value = "Some plain text"), LeafNode(tag = "a", value = "A cool link!", props = {"href":"https://google.com", "target": "_blank"})]
testParent = ParentNode("p", testChildList, None)
